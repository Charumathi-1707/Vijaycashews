  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        onClick={() => itemCount > 0 && navigate("/checkout")}
        disabled={itemCount === 0}
        className={`group mt-6 flex w-full items-center justify-center gap-2 rounded-full py-4 font-semibold text-white shadow-lg transition-all duration-300 ${itemCount > 0 ? "bg-gradient-to-r from-yellow-600 to-yellow-700 hover:shadow-xl" : "bg-gray-300 cursor-not-allowed"}`}
      >
