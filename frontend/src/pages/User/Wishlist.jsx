          ...
          {wishlistItems.length === 0 ? (
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {wishlistItems.map((product) => (
                <div key={product.id || product._id || product.productId} className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <button
                      onClick={() => removeFromWishlist(product.id || product._id || product.productId)}
