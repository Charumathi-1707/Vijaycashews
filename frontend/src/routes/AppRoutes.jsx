  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/admin/drivers" element={<ProtectedRoute allowRoles={["admin"]}>{<AdminDrivers />}</ProtectedRoute>} />
        <Route path="/admin/products" element={<ProtectedRoute allowRoles={["admin"]}>{<AdminProducts />}</ProtectedRoute>} />
